...
def train(X_train, X_val, y_train, y_val,num_classes):
    ...
    x = Dense(2048, activation='relu', kernel_regularizer=l2(0.01))(x)  # Apply L2 regularization
    x = Dense(1024, activation='relu', kernel_regularizer=l2(0.01))(x)  # Apply L2 regularization
    x = Dense(512, activation='relu')(x)  # No regularization applied
    x = Dense(256, activation='relu')(x)  # No regularization applied
    x = Dense(128, activation='relu')(x)  # No regularization applied
